			...
			<div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
				<div className='flex justify-between h-16 items-center'>
					<div className='flex-shrink-0'>
						<h1 className='text-xl font-bold'>Book Leizure</h1>
					</div>
					...
					<div className='flex items-center gap-4'>
						{session ? (
							...
							<form
								...
								<button
									type='submit'
									className='flex items-center gap-2 rounded-full bg-white px-4 py-2 border hover:bg-gray-50 transition-colors'>
